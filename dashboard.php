...
// Fetch sales data for the logged-in supplier
$sales = $conn->query("SELECT sales.quantity, sales.sale_date, products.product_name, buyers.username 
                        FROM sales 
                        JOIN products ON sales.product_id = products.id 
                        JOIN users AS buyers ON sales.buyer_id = buyers.id 
...
<head>
    ...
    <style>
        ...
        .form-container, .products-container, .buyer-products-container, .sales-container {
...
<?php if ($_SESSION['user_type'] == 'supplier'): ?>
    ...
    <div class="sales-container">
        ...
        <div class="sale-item">
            ...
            <p>Sold to: <?php echo $row['username']; ?></p>
            <p>Quantity: <?php echo $row['quantity']; ?></p>
            <p>Date: <?php echo $row['sale_date']; ?></p>
        </div>
        <?php endwhile; ?>
    </div>
